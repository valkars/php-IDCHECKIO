...
class ControlGroup implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'result_msg' => 'string',
        'result' => 'string',
        'control' => '\idcheckio\model\Control[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['result_msg'] = $data['result_msg'] ?? null;
        $this->container['result'] = $data['result'] ?? null;
        $this->container['control'] = $data['control'] ?? null;
    }
     ...
     * Sets control
     *
     * @param Control[] $control control list
     * @return $this
     */
